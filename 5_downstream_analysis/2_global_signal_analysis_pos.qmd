...
- separate pos and neg for plots
...
ggplot(plot_data, aes(x = Lab, y = log2(BPC_Area), fill = Lab)) +
  ...
  labs(
    title = "Full Data BPC Across Laboratories (Positive Mode)",
...
ggplot(plot_data_tic, aes(x = Lab, y = log2(TIC_Area), fill = Lab)) +
  ...
  geom_quasirandom(aes(color = Mixture), dodge.width = 0.9, size = 2) +
  labs(
    title = "Full Data TIC Across Laboratories (Positive Mode)",
    subtitle = "Points colored by mixture type",
    x = "Laboratory",
    y = "Log2(TIC Area)"
  ) +
...
ggplot(plot_data_ratio, aes(x = Lab, y = BPC_TIC_Ratio, fill = Lab)) +
  ...
  geom_quasirandom(aes(color = Mixture), dodge.width = 0.9, size = 2) +
  labs(
    title = "Full Data BPC/TIC Ratio Across Laboratories (Positive Mode)",
    subtitle = "Points colored by mixture type",
    x = "Laboratory",
    y = "BPC/TIC Ratio"
  ) +
...
ggplot(plot_data, aes(x = rt_bin, y = value, color = lab, group = sample_id)) +
  ...
  labs(
    title = "Chromatographic Fingerprint Comparison (Full Data - Positive Mode)",
...
- honestly no idea of what to do with this...
...
ggplot(plot_data, aes(x = rt_bin, y = value, color = lab, group = sample_id)) +
  ...
  facet_grid(metric ~ mixture, scales = "free_y") +
  labs(
    title = "Chromatographic Fingerprint Comparison (Annotated Data - Positive Mode)",
