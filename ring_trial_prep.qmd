...
- Look at the BPC of different NAPS injection throughout the runs, visible RT shift ? 
...
-   extract all the ones that we cannot automaticaly find. see if because
...
- For adducts: also plot RT slices through the m/z range ? 
