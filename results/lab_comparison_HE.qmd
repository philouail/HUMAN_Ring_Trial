...
```{r, eval=I(!file.exists("object/sp_full.RData"))}
...
```{r, eval =!file.exists("object/tic_full.RData")}
...
```{r, eval=I(!file.exists("object/sp_full_detect.RData"))}
...
```{r, eval =I(!file.exists("object/bpc_detected.RData"))}
...
```{r, eval =I(!file.exists("object/tic_detect.RData"))}
