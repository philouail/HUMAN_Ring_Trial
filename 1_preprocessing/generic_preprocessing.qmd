...
lab <- "hmgu" # change to the lab folder (e.g. "cembio", "icl", "hmgu")
...
mse <- readMsExperiment(file.path(study_path, "mzml", seq$filename),
                        seq)
...
dr <- file.path(study_path, "eics_full_rt_slices", "M_ions")
