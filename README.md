...
laboratories, mixtures obtained from the MetaSci metabolite standard library
are measured. Since the ground truth (number and identity of metabolite) is
known, we can compare the different chromatographic methods within a laboratory
and compare the different LC-MS setups from different laboratories using the
standardized method.
