---
title: "AFEKTA Library Generation - Human Endosome (HE)"
format: html
---

# Introduction

This document generates compound annotation libraries from AFEKTA's ring trial data for the Human Endosome (HE) mixture.
...
**Data Structure:**
- MS1/MS2 processed data: `1_preprocessing/afekta/HE/`
- Manual curation results: `3_annotation_manual/HE/`
- Automatic annotation results: `2_annotation_auto/afekta/HE/`
...
## Extract MS2 Spectra (two injections)

```{r extract-ms2}
# AFEKTA uses two injections; keep automate_matching_ms2 active
...
# Optional: Single-injection method (leave commented for AFEKTA)
