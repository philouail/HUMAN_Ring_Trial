...
library(readxl)
res_table <- read_xlsx(file.path(dr, "peak_evidence_rt_groupedTF.xlsx")) |> 
    as.data.frame()
```
...
res_table <- res_table[!is.na(res_table$Validation), ]
res_true <- res_table[res_table$Validation == "TRUE", ] 
