---
title: "HMGU Library Generation - Human Endosome (HE)"
format: html
---

# Introduction

This document generates compound annotation libraries from HMGU's ring trial data for the Human Endosome (HE) mixture.
...
**Data Structure:**
- MS1/MS2 processed data: `1_preprocessing/hmgu/HE/`
- Manual curation results: `3_annotation_manual/HE/`
- Automatic annotation results: `2_annotation_auto/hmgu/HE/`
...
# pp <- precursorPurity(spectra(mse), tolerance = 0.05, ppm = 0)
# spectra(mse)$precursorPurity <- pp
```
...
## Extract MS2 Spectra (single injection with chromPeakSpectra)

```{r extract-ms2}
# HMGU uses single injection; use chromPeakSpectra instead of automate_matching_ms2
