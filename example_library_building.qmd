...
For chrompeak matching we will later do it in a loop, mixture per mixture. 
The rest of the library building is then run on the whole res object. 
For the example i will not set up the loop and we only look into mixture "1.1".
