...
library(readxl)
res_table <- read_xlsx(file.path(dr, "peak_evidence_rt_grouped_curated_ICL.xlsx"))
```
...
res_table <- res_table[!is.na(res_table$VALIDITY), ]
res_true <- res_table[res_table$VALIDITY == "TRUE", ]
